<div>
    ...
    <div class="bg-surface border-4 border-border-dark rounded-card shadow-hard p-6 mb-8">
        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <x-button @click="$dispatch('open-modal', { id: 'client-form' })" variant="primary" size="md" class="w-full sm:w-auto">
                        ...
                        <tr class="border-b-2 border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <x-button variant="ghost" size="sm" wire:click="edit({{ $client->id }})">
                                        <i class="bx bx-edit text-base"></i>
                                    </x-button>
                                    <x-button variant="ghost" size="sm" wire:click="view({{ $client->id }})">
                                        <i class="bx bx-show text-base"></i>
                                    </x-button>
                                    <x-button variant="ghost" size="sm" wire:click="confirmDelete({{ $client->id }})">
